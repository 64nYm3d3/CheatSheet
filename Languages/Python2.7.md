...
print "Can perform variable substitution the a percent and s, like this %s, and the contents of the variable \" i \" will be displayed here" % i
print "You can append a number onto a print statement like this", i + 32 ," and the variable plus 32 will be displayed if it's an int"
~~~
